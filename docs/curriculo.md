...
<a href="../assets/index.html" target="_blank" class="md-button md-button--primary">Visualizar Currículo Interativo</a>
...
**Contato:** [rodrigo.pp.toledo@gmail.com](mailto:rodrigo.pp.toledo@gmail.com) | +55 41 992075458 | [LinkedIn](https://www.linkedin.com/in/rodrigopptoledo)
...
Minha missão é aproveitar dados e tecnologia para resolver problemas complexos e criar valor para nossos clientes e stakeholders. Apliquei ciência de dados em diversos domínios, como RH, telemedicina, vendas, detecção de fraudes e previsão de preços.
...
#### Senior Data Scientist | Pin People
...
#### Machine Learning Engineer | Portal Telemedicina
...
- **Doutorado (PhD) em Informática** - Universidade Estadual de Campinas (2019-2023)
- **Pós-Graduação em Data Science & Big Data** - Universidade Positivo (2020-2021)
- **Bacharelado em Matemática** - Centro Universitário Internacional UNINTER (2016-2020)
- **Especialização em Qualidade** - Fundação Vanzolini (2014-2015)
- **Mestrado em Engenharia Química** - Universidade Estadual de Campinas (2005-2010)

### Competências Técnicas

- **Linguagens de Programação:** Python, R, SQL
- **Cloud:** AWS, Azure, AWS Bedrock
- **Machine Learning & AI:** NLP, Modelos Preditivos, GenAI, Detecção de Fraudes
- **DevOps & Engenharia:** MLOps, DevOps, LLMOps
- **Estatística & Analytics:** Análise Avançada, Modelagem Estatística, Visualização de Dados
...
- Foundations of Data Science: Inferential Thinking by Resamplin# Meu Currículo
...
- Data Science: R Basics
- Foundations of Data Science: Computational Thinking with Python
- Foundations of Data Science: Inferential Thinking by Resamplingg